...
# accouts_arr = [["深圳市元极创新电子有限公司", "caigou02", "Yjcx123"]]
accouts_arr = [["深圳市元极创新电子有限公司", "caigou02", "Yjcx123"]]
# sourceFile_dic = {'fileName': PathHelp.get_file_path(None, 'TKWPageMore.xlsx'),
#            'sourceSheet':'page_more',
#             'colIndex':1,
#            'startIndex':12000,
#            'endIndex':13000} # 12000 unfinished
# result_save_file = PathHelp.get_file_path('Bom_price', 'bom_price_cate_kwpage15k.xlsx')

sourceFile_dic = {'fileName': PathHelp.get_file_path(None, 'TInfineon_keywords.xlsx'),
                  'sourceSheet': 'unfinished_ppn',
                  'colIndex': 1,
                  'startIndex': 2294,
                  'endIndex': 4000}  #2142 unfinished
result_save_file = PathHelp.get_file_path('Bom_price', 'bom_price_cate_Infenion_26k.xlsx')
