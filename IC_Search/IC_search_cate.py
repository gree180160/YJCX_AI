...
from IC_stock import IC_stock_excel_read, IC_Stock_excel_write, IC_stock_cate
import cv2
import re
import shutil
import os
...
def saveSearchInfo(info_arr, isWeek, cate_name):
    ...
    IC_Stock_excel_write.add_arr_to_sheet(file_name=file_name, sheet_name=sheet_name_base64str,
                                          dim_arr=info_arr)
...
def main():
    global current_cate_has_date
    cate_ids = IC_stock_excel_read.get_cate_name_arr('/Users/liuhe/PycharmProjects/SeleniumDemo/IC_Search/T0815.xlsx',
                                                     'left', 1)
