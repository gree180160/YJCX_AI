...
if __name__ == "__main__":
    rec_image(fold_path='/Users/liuhe/Desktop/progress/TRenesas_MCU/Renesas_MCU_115H/11/IC_hot_images')
    time.sleep(2.0)
    rec_image(fold_path='/Users/liuhe/Desktop/progress/TRenesas_MCU/Renesas_MCU_115H/sz/IC_hot_images')
    time.sleep(2.0)
    rec_image(fold_path='/Users/liuhe/Desktop/progress/TRenesas_MCU/Renesas_MCU_115H/04/IC_hot_images')
    time.sleep(2.0)
