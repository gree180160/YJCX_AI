    ...
    while True:
        ...
        for temp_item in items:
            try:
                ...
                item_content = [No, row_title, start_pri, app_secu, contr_secu, status, publish_date, end_date, show_date,
...
def pre_deal_excel(date):
    ...
    title_arr = [['No', 'title', 'starting_price', 'application_security', 'contract_security', 'status', 'published',
