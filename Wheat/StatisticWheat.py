...
def statistic_buy():
    ppn_list = ExcelHelp.read_col_content(file_name=PathHelp.get_file_path('TSTM_discontiueP4', 'Task.xlsx'), sheet_name='ppn', col_index=1)
    source_file = PathHelp.get_file_path('TSTM_discontiueP4', 'wheat_buyer.xlsx')
