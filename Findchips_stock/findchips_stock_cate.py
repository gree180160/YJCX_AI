...
import requests
from WRTools import IPHelper, UserAgentHelper, LogHelper, WaitHelp, EmailHelper, ExcelHelp
...
result_sheet_name = 'findchips_0912am'
...
def get_findchips_stock(cate_index, cate_name):
    ...
    print('url is:', url)
    try:
        req = requests.get(url=url, headers=headers, cookies=cookies, proxies=IPHelper.getRandowProxy_contry3(), timeout=(60, 120))
