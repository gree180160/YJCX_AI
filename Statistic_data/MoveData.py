...
if __name__ == "__main__":
    source_file = PathHelp.get_file_path('TInfenion_25H', 'TInfenion_25H.xlsx')
    ...
    move_findchip_to_allInfo(source_file=source_file, findchip_file=PathHelp.get_file_path('TInfenion_25H', 'findchip_stock.xlsx'))
