...
def pre_combine_data():
    cate_source_file = PathHelp.get_file_path("TRenesas_all_165H", 'Task.xlsx')
    # reco hot images
    hot_image_files = ['/Users/liuhe/Desktop/progress/TReneseas_all/165H/11/IC_hot_images',
                       '/Users/liuhe/Desktop/progress/TReneseas_all/165H/sz/IC_hot_images',
                       '/Users/liuhe/Desktop/progress/TReneseas_all/165H/04/IC_hot_images',
                       PathHelp.get_IC_hot_image_fold("TRenesas_all_165H")
                       ]
    ...
    IC_stock_result.combine_result(source_files=ICStock_file_arr, aim_file=PathHelp.get_file_path('TRenesas_all_165H', 'IC_stock.xlsx'))
    IC_stock_result.IC_stock_sum(IC_source_file=PathHelp.get_file_path('TRenesas_all_165H', 'IC_stock.xlsx'), cate_source_file=cate_source_file)
    findchips_stock_cate.combine_result(["/Users/liuhe/Desktop/progress/TReneseas_all/165H/11/findchip_stock.xlsx",
                                         "/Users/liuhe/Desktop/progress/TReneseas_all/165H/04/findchip_stock.xlsx",
                                         "/Users/liuhe/Desktop/progress/TReneseas_all/165H/sz/findchip_stock.xlsx"],
                                        PathHelp.get_file_path('TRenesas_all_165H', 'findchip_stock.xlsx'))
...
def statistic_data():
    ...
    move_findchip_to_allInfo(source_file=source_file, findchip_file=PathHelp.get_file_path('TRenesas_all_165H', 'findchip_stock.xlsx'))
    move_digiKey(source_file=source_file, digikey_file=PathHelp.get_file_path("TRenesas_all_165H", 'digikey_status.xlsx'), source_sheet='My Lists Worksheet')
