...
cate_source_file = PathHelp.get_file_path(None, 'TE01.xlsx')
result_save_file = PathHelp.get_file_path('Octopart_price', 'octopart_price_cate_E01.xlsx')
...
def get_zmz():
    T0806_arr = IC_stock_excel_read.get_cate_name_arr("/Users/liuhe/PycharmProjects/SeleniumDemo/IC_stock/T0806.xlsx", 'all', 1)
    T0815_arr = IC_stock_excel_read.get_cate_name_arr("/Users/liuhe/PycharmProjects/SeleniumDemo/IC_Search/T0815.xlsx", 'all', 1)
    finish_arr = T0806_arr + T0815_arr
    zmz_arr = IC_stock_excel_read.get_cate_name_arr("/Users/liuhe/PycharmProjects/SeleniumDemo/T0829zmz.xlsx", 'all', 1)
    unvalid_arr = list(set(zmz_arr).intersection(set(finish_arr)))
    # valid_arr.sort()
    print(unvalid_arr)
